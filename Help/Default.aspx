...
<asp:Content ID="Content6" ContentPlaceHolderID="Main" runat="server">
    ...
    <h5 id="news">News Release Work Order...</h5>
    <p>When filling out the news release work order, attach a draft version of your news release to the work order. Upon submission of the work order, a member of Communications Services will format and edit your news release as needed, and return the revised news release to you and your Program Manager for final approval. Once approved, the final news release will be sent to the media.</p>
