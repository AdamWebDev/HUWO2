        ...
        */
        _injectTimePicker: function () {
            ...
            if ($dp.find("div.ui-timepicker-div").length === 0 && o.showTimepicker) {
                ...
                $.Function.append.apply(this.timezone_select,
    ...
    $.Function.extend({
        ...
        */
        timepicker: function (o) {
            ...
            return $(this).each(function () {
                $.Function.datetimepicker.apply($(this), tmp_args);
            });
        },
        ...
        */
        datetimepicker: function (o) {
            ...
            if (typeof (o) == 'string') {
                if (o == 'getDate') {
                    return $.Function.datepicker.apply($(this[0]), tmp_args);
                } else {
                    return this.each(function () {
                        var $t = $(this);
